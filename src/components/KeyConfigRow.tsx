...
function keyConfigFromShortCut(
...
function shortCutIndex(applicationShortCuts: readonly ApplicationShortCut[], config: KeyConfig): number | '' {
...
export const KeyConfigRow = React.memo<KeyConfigRowProps>(({config, index, onChange, applicationShortCuts}) => {
  ...
  return (
    <TableRow>
      <TableCell align="center">{config.buttonNumber}</TableCell>
      ...
      <TableCell align="center">
        <Checkbox
          ...
          onChange={(e) => onChange(index, {...config, control: e.target.checked})}
        />
      </TableCell>
      <TableCell align="center">
      ...
      {applicationShortCuts && (
        <TableCell align="center">
          <NativeSelect
            ...
            onChange={(e) =>
              onChange(index, keyConfigFromShortCut(applicationShortCuts, config.buttonNumber, e.target.value))
            }
            className={classes.keyInput}>
            <option value="" />
